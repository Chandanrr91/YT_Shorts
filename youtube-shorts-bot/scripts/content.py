    ...
    "properties": {
        ...
        "narration": {
            ...
            "description": (
                ...
                "(a surprising question or statement which should engage any viewer) in the first 3 seconds."
                "Then deliver the fact conversationally in 2-3 tight sentences, and end with a warm one-line "
...
def build_script(title, raw_fact, source_url):
    ...
    system = (
        ...
        "in the first 3 seconds which should be very interesting and keeps them watching. CRITICAL RULES:\n"
        ...
        "- Make it ENGAGING: open with a hook, use vivid plain language, build curiosity with little exaggeration "
        " and land a satisfying takeaway. Avoid dry encyclopedia phrasing.\n"
